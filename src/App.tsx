        ...
        <div className="grid gap-14 md:grid-cols-3 md:gap-10">
          ...
          <div className="flex flex-col items-start md:items-end">
            ...
            <div className="mb-10 flex gap-3">
              ...
              <a href="https://www.facebook.com/poojajewellers123" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex h-11 w-11 items-center justify-center rounded-2xl border border-white/10 text-white/50 transition-all duration-300 hover:border-camel hover:text-camel">
                <FacebookIcon className="h-4 w-4" />
              </a>
              <a href="https://api.whatsapp.com/send/?phone=9960184674&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="flex h-11 w-11 items-center justify-center rounded-2xl border border-white/10 text-white/50 transition-all duration-300 hover:border-camel hover:text-camel">
